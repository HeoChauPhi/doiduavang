...
if(!is_admin()) {
  ...
  function ct_libs_scripts() {
    ...
    wp_register_script('lib-waypoints', get_stylesheet_directory_uri() . '/dist/js/libs/waypoints.min.js', array('jquery'),  FALSE, '2.0.3', TRUE);
    wp_enqueue_script('lib-waypoints');

    wp_register_script('lib-counterup', get_stylesheet_directory_uri() . '/dist/js/libs/jquery.counterup.min.js', array('jquery'),  FALSE, '1.0', TRUE);
